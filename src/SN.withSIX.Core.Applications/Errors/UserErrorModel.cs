// <copyright company="SIX Networks GmbH" file="UserErrorModel.cs">
...
namespace SN.withSIX.Core.Applications.Errors
{
    ...
    {
        public Func<object, RecoveryOptionResultModel> Handler;
        ...
        public static RecoveryCommandModel Ok
        {
            get
            {
                var ret = new RecoveryCommandModel("Ok", _ => RecoveryOptionResultModel.RetryOperation) {
                    IsDefault = true
                };
                return ret;
            }
        ...
        public static RecoveryCommandModel Continue
        {
            get
            {
                var ret = new RecoveryCommandModel("Continue", _ => RecoveryOptionResultModel.RetryOperation) {
                    IsDefault = true
                };
                return ret;
            }
        ...
        public static RecoveryCommandModel Cancel
        {
            get
            {
                var ret = new RecoveryCommandModel("Cancel", _ => RecoveryOptionResultModel.CancelOperation) {
                    IsCancel = true
                };
                return ret;
            }
        ...
        public static RecoveryCommandModel Yes
        {
            get
            {
                var ret = new RecoveryCommandModel("Yes", _ => RecoveryOptionResultModel.RetryOperation) {
                    IsDefault = true
                };
                return ret;
            }
        ...
        public static RecoveryCommandModel No
        {
            get
            {
                var ret = new RecoveryCommandModel("No", _ => RecoveryOptionResultModel.CancelOperation) {
                    IsCancel = true
                };
                return ret;
            }
