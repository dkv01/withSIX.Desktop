// <copyright company="SIX Networks GmbH" file="LookupService.cs">
...
public class LookupService : IDisposable
{
    ...
    static readonly int COUNTRY_BEGIN = 16776960;
    static readonly int STRUCTURE_INFO_MAX_SIZE = 20;
    static readonly int DATABASE_INFO_MAX_SIZE = 100;
    static readonly int FULL_RECORD_LENGTH = 100; //???
    static readonly int SEGMENT_RECORD_LENGTH = 3;
    static readonly int STANDARD_RECORD_LENGTH = 3;
    static readonly int ORG_RECORD_LENGTH = 4;
    static readonly int MAX_RECORD_LENGTH = 4;
    static readonly int MAX_ORG_RECORD_LENGTH = 1000; //???
    static readonly int FIPS_RANGE = 360;
    static readonly int STATE_BEGIN_REV0 = 16700000;
    static readonly int STATE_BEGIN_REV1 = 16000000;
    static readonly int US_OFFSET = 1;
    static readonly int CANADA_OFFSET = 677;
    static readonly int WORLD_OFFSET = 1353;
    ...
    public Country getCountry(IPAddress ipAddress) => getCountry(bytestoLong(ipAddress.GetAddressBytes()));
    ...
    public int getID(IPAddress ipAddress) => getID(bytestoLong(ipAddress.GetAddressBytes()));
    ...
    public Region getRegion(IPAddress ipAddress) => getRegion(bytestoLong(ipAddress.GetAddressBytes()));
    ...
    public Location getLocation(IPAddress addr) => getLocation(bytestoLong(addr.GetAddressBytes()));
    ...
    public string getOrg(IPAddress addr) => getOrg(bytestoLong(addr.GetAddressBytes()));
    ...
    static long swapbytes(long ipAddress) => (((ipAddress >> 0) & 255) << 24) | (((ipAddress >> 8) & 255) << 16)
    ...
    static int unsignedByteToInt(byte b) => b & 0xFF;
}