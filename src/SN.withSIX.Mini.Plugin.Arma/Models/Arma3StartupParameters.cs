...
namespace SN.withSIX.Mini.Plugin.Arma.Models
{
    ...
    {
        public Arma3StartupParameters(string[] defaultParameters) : base(defaultParameters) {}
        public Arma3StartupParameters() {}
    ...
    {
        string[] _identities;
        protected ArmaStartupParameters(string[] defaultParameters) : base(defaultParameters) {}
        protected ArmaStartupParameters() {}
